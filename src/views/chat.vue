    ...
    data() {
      return {
        ...
        responses: {
          ...
          proyek:
            "📁 *Proyek* untuk mengelola pekerjaan besar jadi beberapa tugas kecil trus juga nyatet siapa klien kamu supaya jauh lebih gampang.",
          keuangan:
            "💰 *Keuangan* untuk mencatat income dan expenses. Biar kamu bisa kontrol pengeluaran dan inget jangan boros ya kalo punya duit biar bisa ketabung dan punya duit kalau mau jajan xixixi.",
          invoice:
            "📨 *Invoice* untuk membuat tagihan ke klien dengan template rapi. Biasanya ini dipakai kalo kamu freelance biar kamu bisa nyatet keperluan kamu pada saat lagi ngerjain project sesuatu biar bisa nyatet harganya dan bisa punya template sendiri",
          developer:
